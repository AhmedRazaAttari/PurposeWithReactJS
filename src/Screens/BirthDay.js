...
import { AddCircleOutline, Delete, RemoveRedEye, PhoneEnabled, Mail, ChevronLeft, ChevronRight, MoreHoriz, AddCircle, AssignmentInd, Search } from '@material-ui/icons';
import $ from 'jquery';
import {
    Link
            ...
            <div style={{ display: "flex", width: "100%" }}>
                ...
                <div id="For_SetOpacity" className="AllContent" style={{ width: "100%" }}>
                    ...
                    <div style={{ padding: 20, position: "relative" }}>
                        <div>
                            <b style={{ fontSize: 28, color: "white" }}>Birthday</b>
                        </div>
                        <br />
                        <div style={{ width: "100%", background: "white", position: "relative", borderRadius: 10, overflow: "scroll", overflowY: "hidden", overflowX: "scroll" }}>
                            <div className="TimeLine_header">
                                <b>All BirthDay</b>
                                <Link to="/BirthdayForm"><button style={{ marginLeft: 20, padding: 4, paddingLeft: 15, paddingRight: 15, color: "white", background: "#6e00ff", border: "none", borderRadius: 20, outline: "none" }}>Create &nbsp;<AddCircleOutline /></button></Link>
                            ...
                            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                                ...
                                <b >{today}</b><br />
                                <button style={{  padding: 4, paddingLeft: 10, paddingRight: 10, border: "none", outline: "none" }}><ChevronLeft /></button>
                                <button style={{ padding: 4, paddingLeft: 15, paddingRight: 15, border: "none", borderRadius: 5, outline: "none" }}>Today</button>
                                <button style={{ padding: 4, paddingLeft: 10, paddingRight: 10, border: "none", outline: "none" }}><ChevronRight /></button>
                                <button style={{ padding: 4, paddingLeft: 15, paddingRight: 15, border: "none", borderRadius: 5, outline: "none" }}>Week</button>
                                <button style={{ padding: 4, paddingLeft: 15, paddingRight: 15, border: "none", borderRadius: 5, outline: "none" }}>Month</button>
                                <button style={{ padding: 4, paddingLeft: 15, paddingRight: 15, border: "none", borderRadius: 5, outline: "none" }}>Year</button><br />

                                {/* <button style={{ marginLeft: 20, padding: 4, paddingLeft: 15, paddingRight: 15, border: "none", borderRadius: 5, outline: "none" }}>All</button>
                                <button style={{ marginLeft: 10, padding: 4, paddingLeft: 15, paddingRight: 15, border: "none", borderRadius: 5, outline: "none" }}>Personal</button>
                                <button style={{ marginLeft: 10, padding: 4, paddingLeft: 15, paddingRight: 15, border: "none", borderRadius: 5, outline: "none" }}>Work</button>
                                <button style={{ marginLeft: 10, padding: 4, paddingLeft: 15, paddingRight: 15, border: "none", borderRadius: 5, outline: "none" }}>Friends</button>
                                <button style={{ marginLeft: 10, padding: 4, paddingLeft: 15, paddingRight: 15, border: "none", borderRadius: 5, outline: "none" }}>Other</button> */}
                            </div>
                            <div style={{ padding: 20 }}>
                                <table id="BirthDayTable">
                                    <tr className="heading">
                                        ...
                                        <td style={{ textAlign: "center", width: 100 }}>View</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <Form.Control as="select" style={{ width: 110 }}>
                                    ...
                                    <tr>
                                        <td style={{ paddingLeft: 10, paddingRight: 15 }}><input type="checkbox" /></td>
                                        <td>Create the login and register with Laravel</td>
                                        <td style={{ width: 100, paddingLeft: 22 }}><div className="AssignBtn" onClick={() => this.setState({ UserModal: !this.state.UserModal })}><AssignmentInd /></div></td>
                                        <td style={{ width: 100, paddingLeft: 22 }}><div className="ModalBtn" onClick={() => this.openModal()}><RemoveRedEye /></div></td>
                                        <td style={{ textAlign: "center", width: 160 }}><Mail /><PhoneEnabled /></td>
