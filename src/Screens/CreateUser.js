                ...
                <div id="For_SetOpacity" className="AllContent" style={{ width: "100%" }}>
                    ...
                    <div style={{ padding: 20 }}>
                        <div id="AllForms" style={{ margin: '0 auto', background: "white", position: "relative", borderRadius: 10, padding: 20 }}>
                            <h3>Edit Detail</h3><br />
                            <div style={{ display: "flex" }}>
                                <img src={profilePic} style={{ width: 60, height: 60, borderRadius: "100%" }} />
                            ...
                            <Form.Group controlId="exampleForm.ControlInput1">
                                <Form.Label>Watsapp Number</Form.Label>
                                <Form.Control type="number" placeholder="+40-777 245 549" />
                            </Form.Group>
                            <Form.Group controlId="exampleForm.ControlInput1">
                            ...
                            <Form.Group controlId="exampleForm.ControlInput1">
                                <Form.Label>Alexa Number</Form.Label>
                                <Form.Control type="text" placeholder="+40-777 245 549" />
                            </Form.Group>
