                            ...
                            <div style={{ padding: 20 }}>
                                ...
                                <table id="Pages">
                                    <tr>
                                        ...
                                        <td>your task has been about to expire</td>
                                        <td>notify_applicant_applied</td>
                                        <td>test@example.com</td>
                                    </tr>
                                    <tr>
                                        <td style={{ paddingLeft: 5, paddingRight: 5 }}><input type="checkbox" /></td>
                                        <td>your task has been completed</td>
                                        <td>notify_candidate_register</td>
                                        <td>test@example.com</td>
                                    </tr>
                                    <tr>
                                        <td style={{ paddingLeft: 5, paddingRight: 5 }}><input type="checkbox" /></td>
                                        <td>your task has been created sucessfully</td>
                                        <td>notify_applicant_status_change</td>
                                        <td>test@example.com</td>
                                    </tr>
                                    <tr>
                                        <td style={{ paddingLeft: 5, paddingRight: 5 }}><input type="checkbox" /></td>
                                        <td>your Reminder has been created sucessfully</td>
